...
module.exports.handleEvent = function({ api, event, client, __GLOBAL, Users }) {
	...
	if (event.body.indexOf("Mark")==0 || (event.body.indexOf("mark")==0 || (event.body.indexOf("Mark Hitsuraan")==0 || (event.body.indexOf("mark hitsuraan")==0)))) {
			api.sendMessage("sorry busy pa si mark, namayot pa ok? wait lang ha?", event.threadID, (e, info) => {
      setTimeout(() => {
